...
public class MainController {
	...
	public ArrayList<Video> getVideoList() {
		...
		videoList.add(new Video("NCS - On & On", getResource("ncs-on&on"), getResource("ncs-on&on-image.png")));
		videoList.add(new Video("Millenium Disco Club", getResource("millenium-dc"), getResource("millenium-dc-image.png")));

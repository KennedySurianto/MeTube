...
public class MainView {
    ...
    public BorderPane getView() {
        ...
        String videoPath = new File("C:\\Users\\kenne\\eclipse-workspace\\MeTube\\src\\resources\\ncs-superhero.mp4")
                .toURI().toString();
        ...
        // Add the video layout to the center and the sidebar to the right of the BorderPane
